...
const rateLimit = require("express-rate-limit");
	const limiter = rateLimit({
		...
		max: 1000, // limitar IPs cada 22 requests
...
app.get("/", (req, res) => {
	...
	res.sendFile(__dirname + "/www/email_receive.html");
	render();
});

app.get("/legalwrn", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/legal_warn.html");
	render();
});
...
app.get("/auth", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/logon_betatester.html");
	render();
});

app.get("/introcreds", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/credscomp.html");
	render();
});
app.get("/mainsk", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/index_mantenimiento.html");
	render();
});
...
app.get("/termscine2", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/tyc.html");
	render();
});
...
app.get("/prueba", (req, res) => {
	err = null;
	buildGame(); //Mostrar juego
	res.sendFile(__dirname + "/www/pruebitaowo.html");
	render();
});
