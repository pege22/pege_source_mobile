(() => {
  ...
  var jt, Ki, Hi, sr, zi, Ji, Nt, P, D, a, Qi, b, or, Zi, Y, lr, ar, T, N, L, xe, fe, le, v, fr, V, R, es, ts, hr, pe, Xt, ae, ve, Ge, Te, ce, Tr, Sr, Cr, Rr, Wr, us, sn, Mr, Lr, qr, Pr, ds, Dr, fs, Ar, Or, ps, ms, ws, gs, je, Ir, bt, Vr, Us, on, Ye, ys, bs, an, un, xs, vs, ao;
  var init_kaboom = __esm({
    "node_modules/kaboom/dist/kaboom.mjs"() {
      ...
      Nt = /* @__PURE__ */ __name((i, t, l) => t in i ? jt(i, t, { enumerable: true, configurable: true, writable: true, value: l }) : i[t] = l, "Nt");
      ...
      a = /* @__PURE__ */ __name((i, t) => jt(i, "name", { value: t, configurable: true }), "a");
      Qi = /* @__PURE__ */ __name((i, t) => {
        for (var l in t)
          jt(i, l, { get: t[l], enumerable: true });
      }, "Qi");
      b = /* @__PURE__ */ __name((i, t, l) => (Nt(i, typeof t != "symbol" ? t + "" : t, l), l), "b");
      or = /* @__PURE__ */ __name((i, t, l) => new Promise((w, U) => {
...
`;
      xs = /* @__PURE__ */ new Set(["id", "require"]);
      vs = /* @__PURE__ */ new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
      __name(kr, "kr");
      ...
      ao = a((i = {}) => {
        ...
        a(Gr, "loadBean");
        function _r(e) {
          return e !== void 0 && (w.masterNode.gain.value = z2(e, Ar, Or)), w.masterNode.gain.value;
        }
        __name(_r, "_r");
        a(_r, "volume");
        function Ke(e, n = { loop: false, volume: 1, speed: 1, detune: 0, seek: 0 }) {
          ...
          let d = r.currentTime - o, h = null, m = { stop() {
            ...
            return y !== void 0 && (c.playbackRate.value = z2(y, ps, ms)), c.playbackRate.value;
          }, detune(y) {
            return c.detune ? (y !== void 0 && (c.detune.value = z2(y, ws, gs)), c.detune.value) : 0;
          }, volume(y) {
            return y !== void 0 && (s.gain.value = z2(y, Ar, Or)), s.gain.value;
          }, loop() {
            c.loop = true;
          }, unloop() {
            c.loop = false;
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
        ...
        function kn() {
          H("f1", () => {
            ...
            C.timeScale = Ue(z2(C.timeScale - 0.2, 0, 2), 1);
          }), H("f9", () => {
            C.timeScale = Ue(z2(C.timeScale + 0.2, 0, 2), 1);
          }), H("f10", () => {
            C.stepFrame();
...
`), font: U.fonts[on], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  function loadAssets() {
    ...
    loadSprite("house", "sprites/house_Animation 1_0.png");
    ...
    loadSprite("boton", "sprites/buttonA.png");
  ...
  var require_main = __commonJS({
    "code/main.js"(exports) {
      ...
      scene("game", ({ levelId, coins, anims } = { levelId: 0, coins: 0 }) => {
        ...
        player2.onCollide("developer", (ch) => __async(exports, null, function* () {
        ...
        onKeyDown("c", () => __async(exports, null, function* () {
          player2.move(DASH__MOVE, 0);
          player2.flipX(false);
          player2.biggify(5);
          if (player2.isGrounded() && player2.curAnim() !== "run") {
            player2.play("run");
        ...
        player2.onCollide("popocine1", () => __async(exports, null, function* () {
          play("portal");
          yield wait(1);
          if (levelId + 1 < LEVELS.length) {
            go("game", {
        ...
        player2.onCollide("popopocine2", () => __async(exports, null, function* () {
          play("portal");
          yield wait(1);
          if (levelId + 1 < LEVELS.length) {
            go("game", {
        ...
        const saltauwu = /* @__PURE__ */ __name(() => {
          if (player2.isGrounded()) {
            player2.jump(JUMP_FORCE);
            player2.play("jump");
            player2.biggify(5);
        ...
        onTouchStart((id, pos2) => {
          if (elsupera.hasPoint(pos2)) {
            saltauwu();
            elsupera.opacity = 1;
          }
        });
        const onTouchChanged = /* @__PURE__ */ __name((_, pos2) => {
          if (!elsupera.hasPoint(pos2)) {
